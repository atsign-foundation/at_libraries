import 'package:at_chops/src/hashing/argon2id_hashing_algo.dart';
import 'package:at_chops/src/hashing/at_hashing_algorithm.dart';
import 'package:at_chops/src/hashing/md5_hashing_algo.dart';
import 'package:at_chops/src/hashing/sha512_hashing_algo.dart';
...
class AtHashingAlgorithmFactory {
  ...
  /// - [HashingAlgoType.md5]: returns an instance of [Md5HashingAlgo] (MD5 hashing).
