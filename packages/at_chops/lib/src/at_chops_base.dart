...
abstract class AtChops {
  List<int> encryptBytes(Uint8List data, AtEncryptionAlgorithm encryptionAlgorithm);
  String encryptString(String data, AtEncryptionAlgorithm encryptionAlgorithm);
  List<int> decryptBytes(Uint8List data, AtEncryptionAlgorithm encryptionAlgorithm);
