...
import 'package:at_chops/src/signing/ecc_signing_algo.dart';
import 'package:at_chops/src/signing/pkam_signing_algo.dart';
...
class AtSigningInput {
  ...
  ///
  /// Available implementations are [RSASigningAlgo], [PkamSigningAlgo], [EccSigningAlgo]. Callers can set their own signing algorithm by implementing [AtSigningAlgorithm]
...
class AtSigningVerificationInput {
  ...
  /// SigningAlgorithm that will be used to sign/verify data
  ///
  /// Available options are [RSASigningAlgo], [PkamSigningAlgo], [EccSigningAlgo]
  AtSigningAlgorithm? signingAlgorithm;
